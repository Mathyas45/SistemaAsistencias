...
class MiembroController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('miembros.index')->with('mensaje', 'Se registró de manera correcta');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $miembro->save();
        return redirect()->route('miembros.index')->with('mensaje', 'Miembro actualizado con exito');
    }
    public function destroy($id)
    {
        ...
        Storage::delete('public/' . $miembro->fotografia);
        $miembro->delete();
        return redirect()->route('miembros.index')->with('mensaje', 'Miembro eliminado con exito');
    }
}
